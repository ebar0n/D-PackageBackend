    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('bankaccount', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='sw_payments.BankAccount', verbose_name='Cuenta bancaria')),
                ('vehicle', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='sw_vehicles.Vehicle', verbose_name='Vehículo')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='client',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='sw_users.ClientAccount', verbose_name='Cliente'),
        ),
        migrations.AddField(
            model_name='useraccount',
            name='groups',
        ...
        migrations.AddField(
            model_name='useraccount',
            name='service',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='sw_users.ServiceAccount', verbose_name='Prestador de servicio'),
        ),
        migrations.AddField(
            model_name='useraccount',
